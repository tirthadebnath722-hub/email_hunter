...
Open your terminal and run the following single-line command chain to clone, install dependencies, and make the tool globally executable instantly:

```bash
git clone https://github.com/tirthadebnath722-hub/email_hunter.git && cd email_hunter && chmod +x install.sh && ./install.sh
```
...
3. **Move to global path and set execution permissions:**
   ```bash
